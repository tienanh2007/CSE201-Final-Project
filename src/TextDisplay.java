...
public class TextDisplay extends JPanel{
	...
	protected void paintComponent(Graphics g) {
		...
		g2.drawString("" + r + "  " + String.format("%.2f", r/(r+d+o)*100) + "%", (int)(0.07*(getWidth())), (int)(0.15*(getHeight())));
		g2.setColor(Color.BLUE);
		g2.drawString("" + d + "  " + String.format("%.2f", d/(r+d+o)*100) + "%", (int)(0.07*(getWidth())), (int)(0.3*(getHeight())));
		g2.setColor(Color.GRAY);
		g2.drawString("" + o + "  " + String.format("%.2f", o/(r+d+o)*100) + "%", (int)(0.07*(getWidth())), (int)(0.45*(getHeight())));
